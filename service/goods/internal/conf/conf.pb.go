...
const file_internal_conf_conf_proto_rawDesc = "" +
	"\n" +
	"\x18internal/conf/conf.proto\x12\tgoods.api\x1a\x1egoogle/protobuf/duration.proto\"\x83\x01\n" +
	"\tBootstrap\x12)\n" +
	"\x06server\x18\x01 \x01(\v2\x11.goods.api.ServerR\x06server\x12#\n" +
	"\x04data\x18\x02 \x01(\v2\x0f.goods.api.DataR\x04data\x12&\n" +
	"\x05trace\x18\x03 \x01(\v2\x10.goods.api.TraceR\x05trace\"\xb6\x02\n" +
	"\x06Server\x12*\n" +
	"\x04http\x18\x01 \x01(\v2\x16.goods.api.Server.HTTPR\x04http\x12*\n" +
	"\x04grpc\x18\x02 \x01(\v2\x16.goods.api.Server.GRPCR\x04grpc\x1ai\n" +
	"\x04HTTP\x12\x18\n" +
	...
	"\x04Data\x124\n" +
	"\bdatabase\x18\x01 \x01(\v2\x18.goods.api.Data.DatabaseR\bdatabase\x12+\n" +
	"\x05redis\x18\x02 \x01(\v2\x15.goods.api.Data.RedisR\x05redis\x121\n" +
	"\aelastic\x18\x03 \x01(\v2\x17.goods.api.Data.ElasticR\aelastic\x1a:\n" +
	"\bDatabase\x12\x16\n" +
	...
	"\aElastic\x12\x12\n" +
	"\x04addr\x18\x01 \x01(\tR\x04addr\"z\n" +
	"\bRegistry\x122\n" +
	"\x06consul\x18\x01 \x01(\v2\x1a.goods.api.Registry.ConsulR\x06consul\x1a:\n" +
	"\x06Consul\x12\x18\n" +
	"\aaddress\x18\x01 \x01(\tR\aaddress\x12\x16\n" +
	"\x06scheme\x18\x02 \x01(\tR\x06scheme\"#\n" +
	"\x05Trace\x12\x1a\n" +
	"\bendpoint\x18\x01 \x01(\tR\bendpointB\x1aZ\x18goods/internal/conf;confb\x06proto3"
