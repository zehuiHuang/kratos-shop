...
const file_api_goods_v1_error_reason_proto_rawDesc = "" +
	"\n" +
	"\x1fapi/goods/v1/error_reason.proto\x12\bgoods.v1\x1a\x13errors/errors.proto*H\n" +
	"\vErrorReason\x12\x18\n" +
	"\x0eUSER_NOT_FOUND\x10\x00\x1a\x04\xa8E\x94\x03\x12\x19\n" +
	"\x0fCONTENT_MISSING\x10\x01\x1a\x04\xa8E\x90\x03\x1a\x04\xa0E\xf4\x03B(Z\x15goods/api/goods/v1;v1\xa2\x02\x0eAPIGoodsErrorsb\x06proto3"

var (
	file_api_goods_v1_error_reason_proto_rawDescOnce sync.Once
	file_api_goods_v1_error_reason_proto_rawDescData []byte
)

func file_api_goods_v1_error_reason_proto_rawDescGZIP() []byte {
	file_api_goods_v1_error_reason_proto_rawDescOnce.Do(func() {
		file_api_goods_v1_error_reason_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_goods_v1_error_reason_proto_rawDesc), len(file_api_goods_v1_error_reason_proto_rawDesc)))
	})
...
var file_api_goods_v1_error_reason_proto_goTypes = []any{
...
func file_api_goods_v1_error_reason_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_goods_v1_error_reason_proto_rawDesc), len(file_api_goods_v1_error_reason_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
